...
function WindowStack()
{
     ...
     *
     * @param  {Integer}  targetInDrawer  WindowStack.CENTER_WINDOW, WindowStack.RIGHT_WINDOW or WindowStack.LEFT_WINDOW
     */
    ...
    /**
     * Closes the the current window if we can (the last one added to the stack).
     *
     * @return void
     */
    this.back = function()
    {
        ...
        // In case assign this function directly to UI item, this will pass to the UI item itself, better use that
